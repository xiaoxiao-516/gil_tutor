import svgPaths from "./svg-pqmbevi4jn";
  ...
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="header-view">
      <div className="content-stretch flex flex-col items-center justify-center relative rounded-[4px] shrink-0" data-name="Button 按钮">
        <p className="font-['Alibaba_PuHuiTi_3.0:75_SemiBold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#202224] text-[16px] whitespace-nowrap">2025年</p>
      </div>
      ...
      <div className="content-stretch flex flex-col items-center justify-center relative rounded-[4px] shrink-0" data-name="Button 按钮">
        <p className="font-['Alibaba_PuHuiTi_3.0:75_SemiBold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#202224] text-[16px] whitespace-nowrap">03月</p>
      </div>
    </div>
  );
}
...
function Component33() {
  return (
    <div className="bg-[#6574fc] content-stretch flex flex-col items-center justify-center px-[8px] py-[5px] relative rounded-[16px] shrink-0 size-[28px]" data-name="时间">
...
function Tr4() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center min-h-px min-w-px relative w-full" data-name="tr">
      ...
      <div className="content-stretch flex items-start p-[4px] relative rounded-[14px] shrink-0" data-name="日期状态">
        <Component33 />
      </div>
      <div className="content-stretch flex flex-[1_0_0] flex-col h-[36px] items-center justify-center min-h-px min-w-px relative rounded-[14px]" data-name="日期状态">
        <Component34 />
...
function Component45() {
  return <div className="content-stretch flex flex-col items-center justify-center px-[8px] py-[5px] rounded-[16px] shrink-0 size-[36px]" data-name="时间" />;
}
...
function HeaderView1() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="header-view">
      ...
      <p className="font-['PingFang_SC:Medium',sans-serif] leading-[22px] not-italic relative shrink-0 text-[#101019] text-[14px] text-center whitespace-nowrap">-</p>
      <div className="content-stretch flex flex-col items-center justify-center relative rounded-[4px] shrink-0" data-name="Button 按钮">
        <p className="font-['Alibaba_PuHuiTi_3.0:75_SemiBold',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#202224] text-[16px] whitespace-nowrap">04月</p>
      </div>
    </div>
  );
}
