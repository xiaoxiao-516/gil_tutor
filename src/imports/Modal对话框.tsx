import svgPaths from "./svg-dtsdtme0o";
      ...
      <div className="bg-white relative shrink-0 w-full" data-name="header">
        <div className="overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex gap-[8px] items-start p-[24px] relative w-full">
            <div className="content-stretch flex flex-[1_0_0] flex-col gap-[8px] items-start leading-[0] min-h-px min-w-px not-italic relative">
              <div className="flex flex-[1_0_0] flex-col font-['Alibaba_PuHuiTi_3.0:75_SemiBold',sans-serif] justify-center min-h-px min-w-px relative text-[#101019] text-[20px] w-[206px]">
                <p className="leading-[1.5]">主要标题</p>
              </div>
              <div className="flex flex-col font-['Alibaba_PuHuiTi_3.0:55_Regular',sans-serif] justify-center relative shrink-0 text-[#646b8a] text-[14px] w-[206px]">
                <p className="leading-[1.5]">副标题</p>
              </div>
            </div>
