import svgPaths from "./svg-r57qxbmmrt";
...
function Button13() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative rounded-[12px] w-[140px]" data-name="Button">
      <div aria-hidden="true" className="absolute border border-[rgba(0,0,0,0)] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Alibaba_PuHuiTi_3.0:55_Regular_L3','Noto_Sans_JP:Regular','Noto_Sans:Regular',sans-serif] leading-[21px] left-[37px] text-[#646b8a] text-[14px] top-[8.5px] whitespace-nowrap" style={{ fontVariationSettings: "'wght' 400" }}>
          SOP管理
        </p>
      </div>
    </div>
...
function Frame42() {
  return (
    <div className="content-stretch flex gap-[2px] items-center leading-[1.5] relative shrink-0 text-[14px] whitespace-nowrap">
      ...
      <p className="font-['Avenir:Roman',sans-serif] not-italic relative shrink-0 text-[#4a4fed]" style={{ fontFeatureSettings: "'lnum', 'pnum'" }}>
        75
      </p>
      <p className="font-['Avenir:Roman','Noto_Sans_JP:Regular',sans-serif] relative shrink-0 text-[#838bab]" style={{ fontVariationSettings: "'wght' 400", fontFeatureSettings: "'lnum', 'pnum'" }}>
        /100次
    ...
    <div className="relative shrink-0 size-[18px]">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
        <g id="Frame 2036084199">
          ...
          <path d={svgPaths.p34b6d880} id="Ellipse 2507" stroke="var(--stroke-0, #6574FC)" strokeLinecap="round" strokeWidth="2.5" />
        </g>
      </svg>
    </div>
  );
...
function CustomSelect2() {
  return (
    <div className="bg-[#f4f7fe] content-stretch flex h-[32px] items-center justify-between px-[12px] relative rounded-[8px] shrink-0 w-[200px]" data-name="CustomSelect">
      <p className="font-['Alibaba_PuHuiTi_3.0:55_Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#101019] text-[14px] whitespace-nowrap">2026-03-25</p>
...
function CustomSelect3() {
  return (
    <div className="bg-[#f4f7fe] content-stretch flex h-[32px] items-center justify-between px-[12px] relative rounded-[8px] shrink-0 w-[200px]" data-name="CustomSelect">
      <p className="font-['Alibaba_PuHuiTi_3.0:55_Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#101019] text-[14px] whitespace-nowrap">1小时00分钟</p>
      <div className="relative rounded-[4px] shrink-0" data-name="Button 按钮">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center relative">
          <IconWrapper1 />
        </div>
...
function Frame41() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-[736px]">
      <Frame38 />
      <Frame40 />
    </div>
  );
...
function Container16() {
  return (
    <div className="h-[21px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Alibaba_PuHuiTi_3.0:65_Medium',sans-serif] leading-[21px] left-0 not-italic text-[#101019] text-[14px] top-[-0.5px] whitespace-nowrap">1. 诗歌吟课 1</p>
    </div>
  );
}
...
function Text13() {
  return (
    <div className="h-[18px] relative shrink-0 w-[41.102px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Ic />
        <p className="absolute font-['Alibaba_PuHuiTi_3.0:55_Regular',sans-serif] leading-[1.5] left-[18px] not-italic text-[#838bab] text-[12px] top-[0.5px] whitespace-nowrap">AI课</p>
      </div>
    </div>
  );
}
...
function Text14() {
  return (
    <div className="h-[18px] relative shrink-0 w-[4.289px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Alibaba_PuHuiTi_3.0:55_Regular',sans-serif] leading-[1.5] left-0 not-italic text-[#838bab] text-[12px] top-[0.5px] whitespace-nowrap">·</p>
      </div>
    </div>
  );
}
...
function Text15() {
  return (
    <div className="h-[18px] relative shrink-0 w-[73.039px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Alibaba_PuHuiTi_3.0:55_Regular',sans-serif] leading-[1.5] left-0 not-italic text-[#838bab] text-[12px] top-[0.5px] whitespace-nowrap">预计 30 分钟</p>
      </div>
    </div>
  );
}
...
function Label() {
  return (
    <div className="content-stretch flex gap-[16px] h-[67px] items-center px-[17px] py-px relative rounded-[6px] shrink-0 w-[364px]" data-name="Label">
      <div aria-hidden="true" className="absolute border border-[#dfe3f0] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <TaskManagementPage />
      <div className="relative shrink-0 size-[16px]" data-name="ic_关闭_16">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
          <div className="absolute inset-1/4">
            <div className="absolute inset-[-7.5%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9.2 9.2">
                <path d={svgPaths.p3fe72e80} id="Vector 5646" stroke="var(--stroke-0, #646B8A)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.2" />
              </svg>
            </div>
          </div>
        </div>
...
function Container20() {
  return (
    <div className="h-[21px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Alibaba_PuHuiTi_3.0:65_Medium',sans-serif] leading-[21px] left-0 not-italic text-[#101019] text-[14px] top-[-0.5px] whitespace-nowrap">2.诗歌巩固练习 1</p>
    </div>
  );
}
...
function Text16() {
  return (
    <div className="h-[18px] relative shrink-0 w-[65.234px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <Ic1 />
        <p className="absolute font-['Alibaba_PuHuiTi_3.0:55_Regular',sans-serif] leading-[1.5] left-[18px] not-italic text-[#838bab] text-[12px] top-[0.5px] whitespace-nowrap">巩固练习</p>
      </div>
    </div>
  );
}
...
function Text18() {
  return (
    <div className="h-[18px] relative shrink-0 w-[73.039px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Alibaba_PuHuiTi_3.0:55_Regular',sans-serif] leading-[1.5] left-0 not-italic text-[#838bab] text-[12px] top-[0.5px] whitespace-nowrap">预计 22 分钟</p>
      </div>
    </div>
  );
}
...
function Frame4() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[736px]">
      <div className="content-stretch flex gap-[8px] items-start py-[16px] relative size-full">
        <Label />
        <Label1 />
      </div>
    </div>
...
function Frame33() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0">
      ...
      <p className="font-['Alibaba_PuHuiTi_3.0:55_Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#838bab] text-[12px] whitespace-nowrap">已学21节</p>
      <div className="h-[8px] relative shrink-0 w-0">
        <div className="absolute inset-[0_-0.5px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1 8">
            <path d="M0.5 0V8" id="Vector 5653" stroke="var(--stroke-0, #CFD5E8)" />
      ...
      <p className="font-['Alibaba_PuHuiTi_3.0:55_Regular',sans-serif] leading-[1.5] not-italic relative shrink-0 text-[#838bab] text-[12px] whitespace-nowrap">未学39节</p>
    </div>
  );
}
...
function Text24() {
  return (
    <div className="h-[18px] relative shrink-0 w-[73.039px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
        <p className="absolute font-['Alibaba_PuHuiTi_3.0:55_Regular_L3','Noto_Sans_SC:Regular','Noto_Sans_JP:Regular','Noto_Sans:Regular',sans-serif] leading-[18px] left-0 text-[#838bab] text-[12px] top-[0.5px] whitespace-nowrap" style={{ fontVariationSettings: "'wght' 400" }}>
          预计 26 分钟
        </p>
      </div>
    </div>
...
function TaskManagementPage6() {
  return (
    <div className="bg-[#4a4fed] relative rounded-[3px] shrink-0 size-[16px]" data-name="TaskManagementPage">
...
function Label4() {
  return (
    <div className="bg-[rgba(101,116,252,0.06)] col-1 h-[67px] justify-self-stretch relative rounded-[6px] row-1 shrink-0" data-name="Label">
      <div aria-hidden="true" className="absolute border border-[rgba(101,116,252,0.4)] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[16px] items-center px-[17px] py-px relative size-full">
          <TaskManagementPage6 />
          <TaskManagementPage7 />
...
function Label5() {
  return (
    <div className="bg-[rgba(101,116,252,0.06)] col-2 h-[67px] justify-self-stretch relative rounded-[6px] row-1 shrink-0" data-name="Label">
      <div aria-hidden="true" className="absolute border border-[rgba(101,116,252,0.4)] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[16px] items-center px-[17px] py-px relative size-full">
          <TaskManagementPage8 />
...
function Label11() {
  return (
    <div className="col-2 justify-self-stretch relative rounded-[6px] row-4 self-stretch shrink-0" data-name="Label">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[16px] items-center px-[17px] py-px relative size-full">
          <TaskManagementPage20 />
          <TaskManagementPage21 />
        </div>
      </div>
    </div>
  );
...
export default function Component() {
  return (
    <div className="bg-[#f5faff] relative size-full" data-name="布置 - 默认状态">
      <Frame1 />
      <Sidebar />
      <Frame37 />
      <Frame28 />
