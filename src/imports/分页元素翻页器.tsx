import svgPaths from "./svg-4gue8yfe2q";

export default function Component() {
  return (
    <div className="bg-[#f0f2f7] content-stretch flex items-center justify-center p-[8px] relative rounded-[6px] size-full" data-name="分页元素/翻页器">
      <div aria-hidden="true" className="absolute border border-[#cfd5e8] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="ic_arrow_left">
          ...
          <div className="-scale-y-100 flex-none h-[9.198px] w-[4.375px]">
            <div className="relative size-full" data-name>
              <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.00003 10.5126">
                <path clipRule="evenodd" d={svgPaths.p1dc41340} fill="var(--fill-0, #ABB4D1)" fillRule="evenodd" />
              </svg>
            </div>
          </div>
        </div>
